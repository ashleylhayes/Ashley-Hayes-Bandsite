...
venueTitle1.className = "shows__venue-title";
...
locationTitle1.className = "shows__location-title";
...
location1.className = "shows__location";
...
buyButton1.className = "shows__button";
